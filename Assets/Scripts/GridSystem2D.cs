...
public class GridSystem2D<T>
{
   ...
   public GridSystem2D(int width, int height, float cellSize, Vector3 origin, CoordinateConverter coordinateConverter,
      bool debug)
   {
      this.width = width;
      this.height = height;
   ...
   TextMeshPro CreateWorldText(GameObject parent, string text, Vector3 position, Vector3 dir, int fontsize = 2,
